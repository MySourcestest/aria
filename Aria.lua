------------------------------------------------
-- This Source Was Developed By (ABS) @M9YUM.--
...
DevId = Config.DevId
SudoIds = {Config.SudoIds,1013040857}
...
if tonumber(result.id_) == tonumber(1013040857) then 
Dev_Abs(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md') 
return false  
end  
...
if tonumber(result.sender_user_id_) == tonumber(1013040857) then  
Dev_Abs(msg.chat_id_, msg.id_, 1, 'دي لكك تريد اهينن تاج راسكك؟😏🖕🏿', 1, 'md')
return false
end 
